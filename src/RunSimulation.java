...
public class RunSimulation {
    ...
    public RunSimulation(
        String searchAlgorithm, int start_row, int start_col, int target_row, int target_col, String env_id) {
    ...
    public static void test() {
        String[] searchAlgorithms = {"DFS", "AStar", "RBFS"};
        int trials = 10000;
        ...
        for (final var searchAlgorithm : searchAlgorithms) {
            ...
            for (int i = 0; i < trials; i++) {
                for (final var env : envs) {
                    ...
                    final var completed = robot.completed;
